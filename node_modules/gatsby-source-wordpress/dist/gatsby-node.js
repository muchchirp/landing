...
exports.onPluginInit = (0, _runSteps.runApiSteps)([steps.setGatsbyApiToState, steps.setErrorMap, steps.setRequestHeaders, steps.hideAuthPluginOptions], `onPluginInit`);
exports.onPreBootstrap = (0, _runSteps.runApiSteps)([steps.restoreAuthPluginOptions], `onPreBootstrap`);
exports.pluginOptionsSchema = steps.pluginOptionsSchema;
exports.createSchemaCustomization = (0, _runSteps.runApiSteps)([steps.setGatsbyApiToState, steps.ensurePluginRequirementsAreMet, steps.ingestRemoteSchema, steps.createSchemaCustomization, steps.addRemoteFileAllowedUrl], `createSchemaCustomization`);
